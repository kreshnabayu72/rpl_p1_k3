  ...
  return (
    <div className="homeHeader">
      ...
      <HeaderCategories
        ...
        nofilter={nofilter}
      />
      {lainnya && <MoreCategories filter={filter} />}
    </div>
  );
};
...
const HeaderCategories = ({
  ...
  return (
    <div className="headerCat">
          ...
          return (
            <div
              ...
              onClick={(e) => {
                ...
                if (cat.nama != "Lainnya") filter(cat.nama);
      ...
      <h1>
        {boole || 'Hasil pencarian untuk "' + cari + '"'}
        {cat === "" || 'Hasil pencarian kategori "' + cat + '"'}
      </h1>
    </div>
  );
};

const MoreCategories = ({ filter }) => {
  return (
